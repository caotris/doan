...
if ($query_details && mysqli_num_rows($query_details) > 0) {
...
?>
<?php if ($query_details && mysqli_num_rows($query_details) == 0) {
    echo "<h2>Sản phẩm đã bị xóa</h2>";
    }else{
...
<div class="appCard row m-0">
    ...
    <div class="col-5 detail_product">
        ...
        <div class="product_gift mt-3">
            ...
            <div class="gift_list">
                <span><i class="fa-solid fa-circle-check mr-3"></i>Freeship khi mua 3 sản phẩm</span>
                <br><span><i class="fa-solid fa-circle-check mr-3"></i>Mua 10 sản phẩm tặng 1 sản phẩm</span>
                <br>
            </div>
        </div>

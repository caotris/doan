...
if (isset($_POST['confirmBuy'])) {
    ...
    if ($row_payment['code'] == "#CKNN") {
        ...
        $orderId = $order_code;
        $redirectUrl = "http://localhost/24dinhcongha/user/userCommon/UserIndex.php?usingPage=done";
        $ipnUrl = "http://localhost/24dinhcongha/user/userCommon/UserIndex.php?usingPage=done";
        $extraData = "";
